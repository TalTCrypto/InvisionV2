...
import { PERFORMANCE_AGENT_PROMPT } from "../prompts/system-prompts";
...
export interface PerformanceAgentConfig {
  db: PrismaClient;
...
/**
 * PerformanceAgent - Expert en analyse de performance
 *
 * Spécialisé dans:
 * - Métriques et KPIs
 * - A/B testing
...
export class PerformanceAgent {
  ...
  constructor(private config: PerformanceAgentConfig) {
